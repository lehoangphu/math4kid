...
Since the order matters and repetition is allowed, you have 3 choices for each cupcake.

Total ways = 3 (choices for mom's cupcake) × 3 (choices for dad's cupcake) = 3 × 3 = **9 ways**
...
Each digit can be any of 10 choices (0 to 9), and there are 4 digits.

Total codes = 10 × 10 × 10 × 10 = $$10^4 = 10,000$$ possible codes.
...
Since repetition is allowed and order matters, for each stage, you have 4 choices.

Total arrangements = 4 × 4 × 4 = $$4^3 = 64$$ ways.
...
Since order matters and no repetition is allowed, this is a permutation of 3 items.

Total ways = 3! = 3 × 2 × 1 = **6 ways**
...
Since order matters and no repetition is allowed, this is a permutation of 4 employees.

Total ways = 4! = 4 × 3 × 2 × 1 = **24 ways**
...
Since order doesn't matter and no repetition is allowed, use combinations.

Total groups = C(8, 3) = $$\frac{8!}{3!(8 - 3)!} = \frac{8!}{3!5!} = 56$$ groups.
...
Total combinations = C(10, 5) = $$\frac{10!}{5!(10 - 5)!} = \frac{10!}{5!5!} = 252$$ combinations.

**Answer:** **252 combinations**
...
Since order doesn't matter and repetition is allowed, use combinations with repetition.

Total ways = C(n + r - 1, r) = C(4 + 6 - 1, 6) = C(9, 6)

Calculating C(9,6):

C(9,6) = $$\frac{9!}{6!(9 - 6)!} = \frac{9!}{6!3!} = 84$$ ways.
...
This is a problem of distributing identical items into distinct groups, with possible zero items in a group.

Total ways = C(n + r - 1, r - 1) = C(8 + 3 - 1, 3 - 1) = C(10, 2)

Calculating C(10,2):

C(10,2) = $$\frac{10!}{2!(10 - 2)!} = \frac{10!}{2!8!} = 45$$ ways.
...
Total ways = C(n + r - 1, r) = C(5 + 10 - 1, 10) = C(14, 10)

Calculating C(14,10):

C(14,10) = $$\frac{14!}{10!(14 - 10)!} = \frac{14!}{10!4!} = 1001$$ ways.
